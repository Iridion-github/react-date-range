...
var startDate = (0, _dateFns.subDays)(endDate, 7);
var commonProps = {
  ranges: [{
    startDate: startDate,
    endDate: endDate,
...
describe('DateRange', function () {
  ...
  test('calculate new selection by resetting end date', function () {
    var methodResult = instance.calcNewSelection((0, _dateFns.subDays)(endDate, 10), true);
  ...
  test('calculate new selection by resetting end date if start date is not before', function () {
    var methodResult = instance.calcNewSelection((0, _dateFns.addDays)(endDate, 2), true);
    compareRanges(methodResult.range, {
